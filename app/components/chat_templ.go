...
func ChatDisplay(c types.Chat, msgs []types.SendMessage, members []types.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><div class=\"block\"><form id=\"form\" ws-send _=\"on submit send resetInput to &lt;input/&gt; in me\" autocomplete=\"off\"><input id=\"messageInput\" name=\"chat_message\" class=\"input block\" type=\"text\" placeholder=\"Escreva sua mensagem aqui\" _=\"on resetInput set my value to &#39;&#39;\n                                   on invalid halt default end\" autofocus required> <button class=\"button is-success block\">Enviar</button></form></div></div></div></div></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
